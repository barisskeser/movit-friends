...
sealed class Screen(val route: String){
    object ProfileScreen: Screen("profile_screen") // profile_screen/{${Constants.PARAM_USER_ID}}
    ...
    object MessageScreen: Screen("message_screen") // message_screen/{${Constants.PARAM_USER_ID}}
